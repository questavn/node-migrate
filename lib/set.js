...
MigrationSet.prototype.down = function (migrationName, fn, context) {
  this.migrate('down', migrationName, fn, context)
}
...
MigrationSet.prototype.up = function (migrationName, fn, context) {
  this.migrate('up', migrationName, fn, context)
}
...
MigrationSet.prototype.migrate = function (direction, migrationName, fn, context) {
  if (typeof migrationName === 'function') {
    fn = migrationName
    migrationName = null
  }
  migrate(this, direction, migrationName, fn, context)
}
